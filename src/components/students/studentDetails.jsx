...
{activeTab === 'exams' && (
  <div className="bg-gray-50 rounded-lg shadow-sm">
    <div className="flex flex-col px-4 py-2 sm:flex-row justify-between items-start sm:items-center mb-4 gap-3">
      <h2 className="text-lg font-semibold text-gray-800 flex items-center">
        <svg className="w-5 h-5 mr-2 text-green-500" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center w-full sm:w-auto gap-3 sm:gap-4">
        <div className="flex items-center space-x-2 pr-4 w-full sm:w-auto">
