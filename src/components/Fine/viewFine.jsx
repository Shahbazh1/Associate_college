    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Student Fine Management</h1>
          <p className="text-gray-600">Manage and track student fines for attendance and exam absences</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg shadow p-4 border-l-4 border-green-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">{stats.paidStudents}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-4 border-l-4 border-red-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm">Unpaid Students</p>
                <p className="text-2xl font-bold text-gray-800">{stats.unpaidStudents}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-4 border-l-4 border-purple-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">Rs. {stats.totalFines}</p>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <div className="flex items-center mb-4">
            <FilterIcon />
            <span className="ml-2 text-lg font-semibold text-gray-800">Filters</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              <select
                ...
                className="w-full border border-gray-300 rounded-lg p-3 pl-10 focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none bg-white"
              >
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Attendance Fine</th>
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Exam Fine</th>
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total Fine</th>
                  ...
                  filteredStudents.map((s) => {
                    ...
                    return (
                      <tr key={s.rollNo} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{s.class}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{s.session}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Rs. {fine.attendanceFine}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Rs. {fine.examFine}</td>
                        <td className={`px-6 py-4 whitespace-nowrap text-sm font-medium rounded-full inline-block px-3 py-1 ${totalFineClass}`}>
                          Rs. {fine.total}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center space-x-2">
                            ...
                            <select
                              ...
                              className={`text-sm border-0 rounded-lg p-2 focus:ring-2 focus:outline-none ${
