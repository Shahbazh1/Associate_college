...
const SignIn1 = () => {
  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row h-screen w-full rounded-4xl">
        <div className="flex-[0.6] h-fit">
          <img
            src={college_img}
            alt="college_img"
            className="object-cover w-full h-full lg:rounded-none rounded-br-full lg:h-screen"
          />
        </div>
        <div className="flex-[0.4]  flex flex-col p-6 pr-8 md:px-20 lg:px-8">
          <div className="flex flex-col">
            <ul className="flex flex-row gap-6 text-sky-600 md:text-xl font-semibold self-end">
              <li
          ...
          <div className="flex-1 flex flex-col mt-3 md:mt-15 justify-center md:justify-start lg:justify-center items-start gap-6">
            <div>
              <h1 className="font-medium text-2xl md:text-3xl mb-2">{user} Login</h1>
              <hr className=" w-full bg-green-500 h-0.5 text-green-500" />
            </div>
            <div className="text-black/30">
              <div className="mb-2 md:mb-3 md:w-[500px] lg:w-full">
