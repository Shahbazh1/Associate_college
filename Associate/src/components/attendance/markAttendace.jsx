...
const MarkAttendance = () => {
  ...
  // Periods for attendance
  const periods = [
    { id: 'all', name: 'Full Day', startTime: '09:00', endTime: '03:15' },
    ...
    { id: '5', name: 'Period 5', startTime: '01:00', endTime: '01:45' },
    { id: '6', name: 'Period 6', startTime: '01:45', endTime: '02:30' },
    { id: '7', name: 'Period 7', startTime: '02:30', endTime: '03:15' },
  ]
  ...
  const checkExistingAttendance = () => {
    ...
    if (selectedDate === '2024-01-15' && selectedClass === '1') {
      return {
        '1': 'present',
        '2': 'absent',
        '3': 'late'
  ...
  const saveAttendance = async () => {
    if (!selectedClass || !selectedSession || !selectedDate) {
